...
package com.example.hophacks.databinding;
...
public final class FragmentFirstBinding implements ViewBinding {
  ...
  @NonNull
  public final Button buttonFirst2;
  ...
  private FragmentFirstBinding(@NonNull ConstraintLayout rootView, @NonNull Button buttonFirst,
      @NonNull Button buttonFirst2, @NonNull TextView textviewFirst) {
    this.rootView = rootView;
    this.buttonFirst = buttonFirst;
    this.buttonFirst2 = buttonFirst2;
  ...
  public static FragmentFirstBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.button_first2;
      Button buttonFirst2 = ViewBindings.findChildViewById(rootView, id);
      ...
      return new FragmentFirstBinding((ConstraintLayout) rootView, buttonFirst, buttonFirst2,
          textviewFirst);
    }
